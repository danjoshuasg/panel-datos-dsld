...
export default function PublicDefensoriasPage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      ...
      <div className="bg-demuna-gradient text-white py-8 relative">
        <div className="container mx-auto px-4">
          <div className="flex items-center mb-4">
            <Link
              href="/auth"
              className="mr-4 bg-white/20 hover:bg-white/30 transition-colors rounded-full p-2 flex items-center justify-center"
              aria-label="Volver a la página anterior"
            >
              <ChevronLeft className="h-5 w-5" />
            </Link>
            <h1 className="text-3xl font-bold fade-in">Directorio de DEMUNAS</h1>
          </div>
          <p className="text-gray-100 max-w-3xl slide-up">
            Busque y consulte información sobre las Defensorías Municipales del Niño y del Adolescente (DEMUNAS) y sus
            responsables en todo el Perú.
          </p>
        </div>
      </div>
